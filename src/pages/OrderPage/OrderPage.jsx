...
const OrderPage = () => {
  ...
  const itemsDelivery = [
    ...
    {
      title: '200.000 VND',
      description: 'Từ 5.000.000 VND đến dưới 50.000.000 VND',
    },
    {
      title: 'Free ship',
        ...
        <div style={{ display: 'flex', justifyContent: 'center'}}>
          <WrapperLeft>
            ...
            <WrapperStyleHeaderDilivery>
              <StepComponent items={itemsDelivery} current={priceMemo === 0 ? null : priceMemo <= 2000000 ? 0 : priceMemo >= 2000000 && priceMemo < 5000000 ? 1 : priceMemo >= 5000000 && priceMemo < 50000000 ? 2 : priceMemo >= 50000000 ? 3 : null}/>
            </WrapperStyleHeaderDilivery>
            <WrapperStyleHeader>
