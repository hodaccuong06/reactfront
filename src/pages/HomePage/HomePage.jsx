...
import slider2 from '../../assets/images/sliderDT.webp'
import slider3 from '../../assets/images/ip.png'
      ...
      <div className='body' style={{ width: '100%', backgroundColor: '#efefef', }}>
        ...
        {/* <div>
          ...
          <div style={{ width: '100%', display: 'flex', justifyContent: 'center', marginTop: '10px' }}>
            <WrapperButtonMore
              textbutton={isPreviousData ? 'Load more' : "See more"} type="outline" styleButton={{
